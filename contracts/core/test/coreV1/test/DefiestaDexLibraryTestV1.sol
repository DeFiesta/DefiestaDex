...
contract DefiestaDexLibraryTestV1 {
    ...
    function getUpdatedPriceAverage(
        ...
        return
            DefiestaDexLibraryV1.getUpdatedPriceAverage(
                _fictiveReserveIn,
                _fictiveReserveOut,
    ...
    function computeFirstTradeQtyIn(
        ...
        return
            DefiestaDexLibraryV1.computeFirstTradeQtyIn(
                _amountIn,
                _fictiveReserveIn,
                _fictiveReserveOut,
                _priceAverageIn,
    ...
    function computeFirstTradeQtyOut(
        ...
        return
            DefiestaDexLibraryV1.computeFirstTradeQtyOut(
                _amountOut,
                _fictiveReserveIn,
                _fictiveReserveOut,
                _priceAverageIn,
    ...
    function computeFictiveReserves(
        ...
        return DefiestaDexLibraryV1.computeFictiveReserves(_reserveIn, _reserveOut, _fictiveReserveIn, _fictiveReserveOut);
    }
    ...
    {
        return
            DefiestaDexLibraryV1.applyKConstRuleOut(
                _amountIn,
                _reserveIn,
                _reserveOut,
                _fictiveReserveIn,
    ...
    {
        return
            DefiestaDexLibraryV1.applyKConstRuleIn(
                _amountOut,
                _reserveIn,
                _reserveOut,
                _fictiveReserveIn,
    ...
    {
        return
            DefiestaDexLibraryV1.getAmountOut(
                _amountIn,
                _reserveIn,
                _reserveOut,
                _fictiveReserveIn,
    ...
    {
        return
            DefiestaDexLibraryV1.getAmountIn(
                _amountOut,
                _reserveIn,
                _reserveOut,
                _fictiveReserveIn,
