...
library DefiestaDexLibraryV1 {
    ...
    {
        require(_amountIn > 0, "DefiestaDexLibrary: INSUFFICIENT_INPUT_AMOUNT");
        require(
    ...
    {
        require(_amountOut > 0, "DefiestaDexLibrary: INSUFFICIENT_OUTPUT_AMOUNT");
        require(
