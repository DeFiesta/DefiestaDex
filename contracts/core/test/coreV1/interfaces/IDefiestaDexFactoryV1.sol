...
interface IDefiestaDexFactoryV1 {
    /**
     * @notice emitted at each DefiestaDexPair created
     * @param token0 address of the token0
     * @param token1 address of the token1
     * @param pair address of the DefiestaDexPair created
     * @param totalPair number of DefiestaDexPair created so far
     */
