...
interface IDefiestaDexSwapCallback {
    /**
     * @notice callback data for swap from DefiestaDexRouter
     ...
     */
    function DefiestaDexSwapCallback(int256 _amount0Delta, int256 _amount1Delta, bytes calldata _data) external;
}
