...
interface IDefiestaDexMintCallback {
    /**
    ...
    /**
     * @notice callback to implement when calling DefiestaDexPair.mint
     * @param _data callback data for mint
     */
    function DefiestaDexMintCallback(MintCallbackData calldata _data) external;
}
