...
interface IDefiestaDexPair is IERC20, IERC20Permit {
    /**
     ...
     * that makes safety checks like the DefiestaDexRouter
     ...
     * Should be called from a contract that makes safety checks like the DefiestaDexRouter
     * @param _to address who will receive tokens
