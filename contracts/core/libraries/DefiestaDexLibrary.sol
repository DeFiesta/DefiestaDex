...
library DefiestaDexLibrary {
    ...
    function getUpdatedPriceAverage(
        ...
        require(_currentTimestamp >= _priceAverageLastTimestamp, "DefiestaDexPair: INVALID_TIMESTAMP");
    ...
    {
        require(_param.amount != 0, "DefiestaDexLibrary: INSUFFICIENT_INPUT_AMOUNT");
        require(
            _param.reserveIn != 0 &&
                _param.reserveOut != 0 &&
    ...
    {
        require(_param.amount != 0, "DefiestaDexLibrary: INSUFFICIENT_OUTPUT_AMOUNT");
        require(
