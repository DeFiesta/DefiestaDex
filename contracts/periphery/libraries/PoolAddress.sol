...
library PoolAddress {
     ...
     * @param _factory The DefiestaDex factory contract address
     * @param _tokenA The first token of the pool
     * @param _tokenB The second token of the pool
     * @return pair_ The contract address of the DefiestaDexPair
     */
     ...
     * @return pair_ The contract address of the DefiestaDexPair
     */
    function pairForByStorage(address _factory, address _tokenA, address _tokenB)
        internal
        view
        returns (address pair_)
    {
        return IDefiestaDexFactory(_factory).getPairs(_tokenA, _tokenB);
    }
}
