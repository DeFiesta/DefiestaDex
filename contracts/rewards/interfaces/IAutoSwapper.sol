...
import "../../core/interfaces/IDefiestaDexSwapCallback.sol";
import "../../core/interfaces/IDefiestaDexPair.sol";

interface IAutoSwapper is IDefiestaDexSwapCallback {
    /**
    ...
    /**
     * @notice emitted every time the AutoSwapper swaps and stacks DDEXs
     ...
     * DefiestaDex Pair on mint and burn, and can be forced call by anyone
     * @param _token0 token to be converted to DDEX
     * @param _token1 token to be converted to DDEX
     */
    function executeWork(IERC20 _token0, IERC20 _token1) external;

    /**
     * @notice transfer DDEX from here to address dead
     * @return _amount the transferred DDEX amount
     */
     ...
     */
    function factory() external view returns (IDefiestaDexFactory);

    /**
     * @notice return the DefiestaDexToken address
     * @return DefiestaDexToken address
     */
