...
interface IStaking is IERC20 {
     ...
     * Mint one token of stDDEX and then deposit in the staking farming pool
     * This contract should be the only participant of the staking farming pool
     */
    function initializeFarming() external;

    /**
     * @notice Send DDEX to get shares in the staking pool
     * @param _depositAmount The amount of DDEX to send
     */
    function deposit(uint256 _depositAmount) external;

    /**
     * @notice Send DDEX to get shares in the staking pool with the EIP-2612 signature off chain
     * @param _depositAmount The amount of DDEX to send
    ...
    /**
     * @notice Harvest and withdraw DDEX for the amount of shares defined
     * @param _to The address who will receive DDEX
     * @param _sharesAmount The amount of shares to use
     */
    function withdraw(address _to, uint256 _sharesAmount) external;

    /**
     * @notice Withdraw DDEX for all shares of the sender, will not harvest before. Only use this function in emergency
     *         WARNING: This function may result in a lower amount of DDEX being withdrawn because it bypasses potential
     *         DDEX earnings from farming.
    ...
    /**
     * @notice Harvest the farming pool for the staking, will increase the DDEX
     */
    ...
    /**
     * @notice get DefiestaDex Token contract address
     * @return DefiestaDex contract (address or type for Solidity)
     */
    function DefiestaDexToken() external view returns (IERC20);
