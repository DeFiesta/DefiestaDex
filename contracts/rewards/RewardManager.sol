...
contract RewardManager is IRewardManager {
     ...
     * @param _DefiestaDexToken address of the DefiestaDex token
     * @param _startFarmingCampaign block number the staking pool in the farming will start to give rewards
     */
    constructor(address _farmingOwner, IERC20 _DefiestaDexToken, uint256 _startFarmingCampaign) {
        ...
        staking = new Staking(_DefiestaDexToken, farming);
        farming.addCampaignInfo(staking, _DefiestaDexToken, _startFarmingCampaign);
