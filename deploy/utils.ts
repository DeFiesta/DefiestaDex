...
export function argsWethArbitrumGoerli(): string[] {
  return [
    ...
    "WETH",
    "18",
    "0x1A681d0E32f8a1d0a5ba94113ecBc1A5dF92e50F", // _l2Gateway
    "0x1A681d0E32f8a1d0a5ba94113ecBc1A5dF92e50F", // _l1Address ethereum: 0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2"
  ];
}
...
export const DefiestaDexTokens = {
