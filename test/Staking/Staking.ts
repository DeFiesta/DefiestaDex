...
import { DefiestaDex_USER_BALANCE } from "./utils";
...
export function unitTestsStaking(): void {
  describe("Staking", function () {
    beforeEach(async function () {
      ...
      await this.contracts.DefiestaDexTokenTest.transfer(this.signers.user.address, DefiestaDex_USER_BALANCE);
      await this.contracts.DefiestaDexTokenTest
